...
% zakończenie
\summary
Podczas pracy nad projektem zrealizowałem wszystkie założone wcześniej cele. Dzięki okazji jaką dało mi opracowanie pracy licencjackiej zyskałem duże doświadczenie w pracy nad średniej wielkości projektami informatycznymi. Jedyną niedoskonałością jest nie osiągniecie pełnej responsywności w zakresie widoku kalendarza wydarzeń. Do pracy wykorzystałem niemalże wszystkie nabyte w trakcie trwania studiów umiejętności.
