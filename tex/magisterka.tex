...
\caption{Projekt interfejsu użytkownika. Panel Administracyjny.\label{RYS.2}}
\source{Opracowanie własne}
\end{figure}
...
\caption{Projekt interfejsu użytkownika. Widok Redaktora.\label{RYS.2}}
\source{Opracowanie własne}
\end{figure}
...
\caption{Projekt interfejsu użytkownika. Widok Gościa.\label{RYS.2}}
\source{Opracowanie własne}
\end{figure}
