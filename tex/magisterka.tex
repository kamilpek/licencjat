...
\begin{lstlisting}[language=ruby, title={Przykład kodu generujacego dokment zawierający ilustrację i wstęp do artykułu}]
class ArticleOnePdf < Prawn::Document
...
\begin{figure}[!tbh]
\centering
\includegraphics[width=.7\linewidth]{fig/chartkick}
